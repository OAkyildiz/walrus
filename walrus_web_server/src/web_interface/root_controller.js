angular.module("app").controller("RootCtrl",
	...
	{ label: "Boom Camera", topic: "boom/kinect/qhd/image_mono" },//updated from "boom/kinect/rgb/image"
	{ label: "Boom IR Camera", topic: "boom/kinect/sd/image_ir" } //updated from "boom/kinect/ir/image"
    ];
